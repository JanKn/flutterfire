...
public class FlutterFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public static void startBackgroundIsolate(Context context, long callbackHandle) {
        FlutterEngine sBackgroundFlutterEngine = new FlutterEngine(context);
        ...
        if (appBundlePath != null && !isIsolateRunning.get()) {            
            DartExecutor.DartCallback dartCallback = new DartExecutor.DartCallback(context.getAssets(), appBundlePath, flutterCallback);
